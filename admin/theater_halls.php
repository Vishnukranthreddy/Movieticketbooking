    ...
    if ($theaterId > 0) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add_hall'])) {
            ...
            if ($uploadOk !== 0) {
                ...
                if ($addHallStmt === false) {
                    ...
                    // CORRECTED bind_param for INSERT: "isiss" -> "isiss" (6 variables: i, s, s, i, s, s)
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_hall'])) {
            ...
            if (isset($_FILES["editHallPanoramaImage"]) && $_FILES["editHallPanoramaImage"]["error"] == UPLOAD_ERR_OK) {
                ...
                if($fileType != "jpg" && $fileType != "png" && $fileType != "jpeg" ) { $errorMessage = "Sorry, only JPG, JPEG, PNG are allowed for new panoramas."; $uploadOk = 0; }
            ...
            if ($uploadOk !== 0) {
                ...
                if ($updateHallStmt === false) {
                    ...
                    // CORRECTED bind_param for UPDATE: "ssissii" (7 variables: s, s, i, s, s, i, i)
